...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_252
    maxValidatorCount: Type_252
    chillThreshold: Type_253
    minCommission: Type_254
}
...
export type Type_252 = Type_252_Noop | Type_252_Set | Type_252_Remove
...
export type Type_253 = Type_253_Noop | Type_253_Set | Type_253_Remove

export interface Type_253_Noop {
    __kind: 'Noop'
}

export interface Type_253_Set {
    __kind: 'Set'
    value: number
}

export interface Type_253_Remove {
    __kind: 'Remove'
}

export type Type_254 = Type_254_Noop | Type_254_Set | Type_254_Remove

export interface Type_254_Noop {
    __kind: 'Noop'
}

export interface Type_254_Set {
    __kind: 'Set'
    value: number
}

export interface Type_254_Remove {
    __kind: 'Remove'
}
...
export type Type_382 = Type_382_Rebid | Type_382_Reject | Type_382_Approve

export interface Type_382_Rebid {
    __kind: 'Rebid'
}

export interface Type_382_Reject {
    __kind: 'Reject'
}

export interface Type_382_Approve {
    __kind: 'Approve'
}
...
export type Type_488 = Type_488_Noop | Type_488_Set | Type_488_Remove

export interface Type_488_Noop {
    __kind: 'Noop'
}

export interface Type_488_Set {
    __kind: 'Set'
    value: number
}

export interface Type_488_Remove {
    __kind: 'Remove'
}
...
export type Type_549 = Type_549_V0 | Type_549_V1 | Type_549_V2

export interface Type_549_V0 {
    __kind: 'V0'
    value: Type_550
}
...
export type Type_336 = Type_336_Members | Type_336_Member | Type_336__Phantom

export interface Type_336_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_336_Member {
    __kind: 'Member'
    value: Uint8Array
}

export interface Type_336__Phantom {
    __kind: '_Phantom'
}
...
export type Type_339 = Type_339_Xcm | Type_339_Response

export interface Type_339_Xcm {
    __kind: 'Xcm'
    value: V1MultiLocation
}

export interface Type_339_Response {
    __kind: 'Response'
    value: V1MultiLocation
}
...
export type Type_550 = Type_550_WithdrawAsset | Type_550_ReserveAssetDeposit | Type_550_TeleportAsset | Type_550_QueryResponse | Type_550_TransferAsset | Type_550_TransferReserveAsset | Type_550_Transact | Type_550_HrmpNewChannelOpenRequest | Type_550_HrmpChannelAccepted | Type_550_HrmpChannelClosing | Type_550_RelayedFrom

export interface Type_550_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V0MultiAsset[]
    effects: Type_552[]
}

export interface Type_550_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_552[]
}

export interface Type_550_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_552[]
}

export interface Type_550_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V0Response
}

export interface Type_550_TransferAsset {
    __kind: 'TransferAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_550_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_550_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_550_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_550_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_550_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_550_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_550
}

export type Type_555 = Type_555_WithdrawAsset | Type_555_ReserveAssetDeposited | Type_555_ReceiveTeleportedAsset | Type_555_QueryResponse | Type_555_TransferAsset | Type_555_TransferReserveAsset | Type_555_Transact | Type_555_HrmpNewChannelOpenRequest | Type_555_HrmpChannelAccepted | Type_555_HrmpChannelClosing | Type_555_RelayedFrom | Type_555_SubscribeVersion | Type_555_UnsubscribeVersion

export interface Type_555_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V1MultiAsset[]
    effects: Type_557[]
}

export interface Type_555_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_557[]
}

export interface Type_555_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    assets: V1MultiAsset[]
    effects: Type_557[]
}

export interface Type_555_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V1Response
}

export interface Type_555_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_555_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_555_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_555_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_555_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_555_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_555_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_555
}

export interface Type_555_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_555_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export type Type_561 = Type_561_WithdrawAsset | Type_561_ReserveAssetDeposited | Type_561_ReceiveTeleportedAsset | Type_561_QueryResponse | Type_561_TransferAsset | Type_561_TransferReserveAsset | Type_561_Transact | Type_561_HrmpNewChannelOpenRequest | Type_561_HrmpChannelAccepted | Type_561_HrmpChannelClosing | Type_561_ClearOrigin | Type_561_DescendOrigin | Type_561_ReportError | Type_561_DepositAsset | Type_561_DepositReserveAsset | Type_561_ExchangeAsset | Type_561_InitiateReserveWithdraw | Type_561_InitiateTeleport | Type_561_QueryHolding | Type_561_BuyExecution | Type_561_RefundSurplus | Type_561_SetErrorHandler | Type_561_SetAppendix | Type_561_ClearError | Type_561_ClaimAsset | Type_561_Trap | Type_561_SubscribeVersion | Type_561_UnsubscribeVersion

export interface Type_561_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V1MultiAsset[]
}

export interface Type_561_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V1MultiAsset[]
}

export interface Type_561_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V1MultiAsset[]
}

export interface Type_561_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_561_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_561_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
    dest: V1MultiLocation
    xcm: V2Instruction[]
...
export interface Type_561_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_561_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_561_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_561_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_561_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_561_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V1Junctions
}

export interface Type_561_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V1MultiLocation
    maxResponseWeight: bigint
...
export interface Type_561_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_561_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_561[]
}

export interface Type_561_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_561[]
}

export interface Type_561_ClearError {
    __kind: 'ClearError'
}

export interface Type_561_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V1MultiAsset[]
    ticket: V1MultiLocation
}

export interface Type_561_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_561_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_561_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export type Type_552 = Type_552_Null | Type_552_DepositAsset | Type_552_DepositReserveAsset | Type_552_ExchangeAsset | Type_552_InitiateReserveWithdraw | Type_552_InitiateTeleport | Type_552_QueryHolding | Type_552_BuyExecution

export interface Type_552_Null {
    __kind: 'Null'
}

export interface Type_552_DepositAsset {
    __kind: 'DepositAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
}

export interface Type_552_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_552_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V0MultiAsset[]
    receive: V0MultiAsset[]
}

export interface Type_552_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V0MultiAsset[]
    reserve: V0MultiLocation
    effects: V0Order[]
...
export interface Type_552_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V0MultiAsset[]
    dest: V0MultiLocation
    effects: V0Order[]
...
export interface Type_552_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V0MultiLocation
    assets: V0MultiAsset[]
...
export interface Type_552_BuyExecution {
    __kind: 'BuyExecution'
    fees: V0MultiAsset
    weight: bigint
    debt: bigint
...
export type Type_557 = Type_557_Noop | Type_557_DepositAsset | Type_557_DepositReserveAsset | Type_557_ExchangeAsset | Type_557_InitiateReserveWithdraw | Type_557_InitiateTeleport | Type_557_QueryHolding | Type_557_BuyExecution

export interface Type_557_Noop {
    __kind: 'Noop'
}

export interface Type_557_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_557_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_557_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_557_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_557_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_557_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export interface Type_557_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_555[]
}
